...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0F14] flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-6">
            ...
            <p className="text-[#6B7280]">Sign in to access your global trade dashboard</p>
          </div>

          {/* Demo Hint */}
          <div className="mb-6 p-4 bg-[#1A1E24] border border-white/5 rounded-xl">
            <p className="text-[#6B7280] text-sm mb-2">Demo Mode - Enter any email & password (min 6 chars)</p>
            <button
              type="button"
              onClick={fillDemo}
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <Mail className="w-5 h-5 text-[#6B7280]/50 absolute left-4 top-1/2 -translate-y-1/2" />
                <input
                  type="email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  placeholder="you@company.com"
                  className="w-full h-12 pl-12 pr-4 bg-[#13161B] border border-white/5 rounded-xl text-[#F4F1EA] placeholder-[#6B7280]/50 focus:outline-none focus:border-[#C49A6C] focus:ring-2 focus:ring-[#C49A6C]/20 transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div>
              <label className="block text-[#6B7280] text-sm mb-2">Password</label>
              <div className="relative">
                <Lock className="w-5 h-5 text-[#6B7280]/50 absolute left-4 top-1/2 -translate-y-1/2" />
                <input
                  type={showPassword ? 'text' : 'password'}
                  value={password}
                  onChange={(e) => setPassword(e.target.value)}
                  placeholder="Enter your password"
                  className="w-full h-12 pl-12 pr-14 bg-[#13161B] border border-white/5 rounded-xl text-[#F4F1EA] placeholder-[#6B7280]/50 focus:outline-none focus:border-[#C49A6C] focus:ring-2 focus:ring-[#C49A6C]/20 transition-all"
                  required
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-[#6B7280]/50 hover:text-[#C49A6C] transition-colors"
                >
                  {showPassword ? (
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-white/10 bg-[#13161B]" />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 bg-[#C49A6C] text-[#0D0F14] font-semibold rounded-xl hover:bg-[#D4AA82] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <div className="animate-spin rounded-full h-5 w-5 border-2 border-[#0D0F14] border-t-transparent"></div>
              ) : (
                <>
                  Sign In
      ...
      {/* Right Side - Branding */}
      <div className="hidden lg:flex flex-1 bg-[#13161B] items-center justify-center p-12">
        <div className="text-center max-w-md">
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-[#6B7280] text-sm">Suppliers</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-[#6B7280] text-sm">Countries</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-[#6B7280] text-sm">Traded</p>
            </div>
          </div>
        </div>
      </div>
