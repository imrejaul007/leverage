      ...
      <section className="pt-32 pb-20 px-4 sm:px-8 relative overflow-hidden">
        ...
        <div className={`container mx-auto text-center max-w-5xl transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-black/5 rounded-full mb-8">
            ...
            <span className="text-[#4A4A4A] text-sm font-medium">Connecting Dots to Ports</span>
          </div>
          ...
          {/* Subheadline */}
          <p className="text-lg sm:text-xl text-[#4A4A4A] mb-10 max-w-2xl mx-auto">
        ...
        <div className="container mx-auto">
          ...
          <div className="pt-8 border-t border-black/5 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-[#4A4A4A] hover:text-[#154230] transition-colors">
