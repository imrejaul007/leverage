        ...
        <div className="container mx-auto px-4 sm:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <Link href="/ads" className="nav-link font-medium text-[#154230]">Campaigns</Link>
              <Link href="/ads/analytics" className="nav-link font-medium">Analytics</Link>
              <Link href="/ads/audiences" className="nav-link font-medium">Audiences</Link>
            </nav>
          ...
          {mobileMenuOpen && (
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="lg:hidden mt-4 pt-4 border-t border-black/5">
              <nav className="flex flex-col gap-2">
                ...
                <Link href="/ads" onClick={() => setMobileMenuOpen(false)} className="p-3 hover:bg-black/5 rounded-lg font-medium">Campaigns</Link>
                <Link href="/ads/analytics" onClick={() => setMobileMenuOpen(false)} className="p-3 hover:bg-black/5 rounded-lg font-medium">Analytics</Link>
                <Link href="/ads/audiences" onClick={() => setMobileMenuOpen(false)} className="p-3 hover:bg-black/5 rounded-lg font-medium">Audiences</Link>
              </nav>
            </motion.div>
          )}
        </div>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            {platforms.map((platform) => {
              ...
              return (
                <div key={platform.name} className="bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow cursor-pointer flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: platform.color + '15' }}>
