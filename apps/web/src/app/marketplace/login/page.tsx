      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
            ...
            <p className="text-gray-500 mb-8">Sign in to your LEVERAGE account</p>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link href="/forgot-password" className="text-[#154230] hover:underline">Forgot password?</Link>
              </div>
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              Don't have an account? <Link href="/marketplace/signup" className="text-[#154230] font-medium hover:underline">Sign up</Link>
            </p>
          </div>
