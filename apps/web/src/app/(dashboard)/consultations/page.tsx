...
const experts = [
  { id: '1', name: 'Rakesh Sharma', title: 'Senior Trade Consultant', image: 'RS', rating: 4.9, reviews: 127, price: 1500, subPrice: 1200, online: true, verified: true },
  { id: '2', name: 'Anita Iyer', title: 'Customs & Compliance Expert', image: 'AI', rating: 4.9, reviews: 248, price: 2500, subPrice: 2000, online: true, verified: true },
  { id: '3', name: 'Capt. Vikram Singh', title: 'Logistics Expert', image: 'VS', rating: 4.8, reviews: 89, price: 1800, subPrice: 1440, online: false, verified: true },
  { id: '4', name: 'Neha Bansal', title: 'Trade Finance Expert', image: 'NB', rating: 4.7, reviews: 64, price: 2000, subPrice: 1600, online: false, verified: true },
];
...
const keywords = ['Wheat', 'Sugar', 'Pulses', 'Rice', 'Spices', 'Cotton', 'Tea', 'Coffee'];
    ...
    <div className="min-h-screen bg-[#081512]">
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                <input
                  ...
                  className="w-[480px] h-11 pl-12 pr-4 bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-xl text-white placeholder-[rgba(216,204,188,0.4)] focus:outline-none focus:border-[#C49A6C]"
                />
      ...
      <div className="p-6 flex gap-6">
        ...
        <div className="w-72 space-y-4">
          ...
          <div className="bg-[rgba(255,255,255,0.02)] rounded-2xl p-4">
            <h3 className="text-[#F4F1EA] font-medium mb-4">Top Searched Keywords</h3>
            <div className="flex flex-wrap gap-2">
              {keywords.map(kw => (
                <span key={kw} className="px-3 py-1.5 bg-[#0E3B36] rounded-full text-[#F4F1EA] text-sm">
                  {kw}
                </span>
              ))}
            </div>
        ...
        <div className="flex-1">
              ...
              {experts.map(expert => (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div className="relative">
                      <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${expert.image}`} alt={expert.name} className="w-12 h-12 rounded-full bg-[#0E3B36]" />
                      {expert.online && (
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                <div key={item.num} className="bg-[#0E3B36]/50 rounded-xl p-4">
                  ...
                  <h3 className="text-[#F4F1EA] font-medium mb-1">{item.title}</h3>
          ...
          {/* Ad Spotlight */}
          <div className="bg-[rgba(255,255,255,0.02)] rounded-2xl overflow-hidden">
            <div className="aspect-video bg-gradient-to-br from-[#0E3B36] to-[#081512] flex items-center justify-center">
              <span className="text-6xl">🍚</span>
            </div>
            <div className="p-4">
              <h3 className="text-[#F4F1EA] font-semibold mb-1">Basmati Rice 1121</h3>
          ...
          <div className="w-[420px] flex-shrink-0">
            <div className="bg-[rgba(255,255,255,0.02)] rounded-2xl border border-[rgba(255,255,255,0.05)] p-6 sticky top-6">
              ...
              <div className="flex items-start gap-4 mb-6">
                <div className="relative">
                  <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${selectedExpert.image}`} alt={selectedExpert.name} className="w-16 h-16 rounded-full bg-[#0E3B36]" />
              ...
              <div className="grid grid-cols-3 gap-2 mb-6">
                <div className="bg-[#0E3B36]/50 rounded-xl p-3 text-center">
                  <p className="text-2xl font-bold text-[#C49A6C]">{selectedExpert.reviews}</p>
                  <p className="text-[rgba(216,204,188,0.6)] text-xs">Reviews</p>
                </div>
                <div className="bg-[#0E3B36]/50 rounded-xl p-3 text-center">
                ...
                <div className="bg-[#0E3B36]/50 rounded-xl p-3 text-center">
                  <p className="text-2xl font-bold text-[#C49A6C]">15+</p>
              ...
              <div className="bg-[#0E3B36]/30 rounded-xl p-4 mb-6">
                <h4 className="text-[#F4F1EA] font-medium mb-3">Consultation History</h4>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-[rgba(216,204,188,0.6)]">Total Sessions</span>
                    <span className="text-[#F4F1EA] font-medium">24</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-[rgba(216,204,188,0.6)]">Total Hours</span>
                    <span className="text-[#F4F1EA] font-medium">48.5</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-[rgba(216,204,188,0.6)]">Total Spent</span>
                    <span className="text-[#C49A6C] font-medium">₹72,000</span>
                  </div>
                </div>
              </div>

              {/* Booking Section */}
              <div className="bg-[rgba(255,255,255,0.02)] rounded-xl p-4 mb-6">
                <h4 className="text-[#F4F1EA] font-medium mb-4">Book Session</h4>
                <div className="space-y-3 mb-4">
                  <div>
                    <label className="text-[rgba(216,204,188,0.6)] text-sm mb-2 block">Select Date</label>
                    <select className="w-full h-11 px-4 bg-[#0E3B36]/50 border border-[rgba(255,255,255,0.1)] rounded-xl text-[#F4F1EA] focus:outline-none focus:border-[#C49A6C]">
                      <option>Feb 28, 2024</option>
                      <option>Feb 29, 2024</option>
                  ...
                  <div>
                    ...
                    <select className="w-full h-11 px-4 bg-[#0E3B36]/50 border border-[rgba(255,255,255,0.1)] rounded-xl text-[#F4F1EA] focus:outline-none focus:border-[#C49A6C]">
                      <option>30 Minutes - ₹{Math.round(selectedExpert.price / 2)}</option>
                      <option>60 Minutes - ₹{selectedExpert.price}</option>
                      <option>90 Minutes - ₹{Math.round(selectedExpert.price * 1.5)}</option>
                    </select>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-[rgba(216,204,188,0.6)]">Total Amount</span>
                    <span className="text-[#C49A6C] font-bold text-lg">₹{Math.round(selectedExpert.price / 2)}</span>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 bg-[#0E3B36]/50 rounded-xl rounded-tl-none p-3">
                      <p className="text-[#F4F1EA] text-sm">Sure, I can help you with the HSN code classification.</p>
                  ...
                  <div className="flex gap-3 justify-end">
                    <div className="bg-[#C49A6C]/20 rounded-xl rounded-tr-none p-3 max-w-[200px]">
                      <p className="text-[#F4F1EA] text-sm">It&apos;s textile machinery for fabric printing</p>
