...
const autoInvoiceRules = [
  { id: 1, name: 'Monthly Retainer - ABC Imports', client: 'ABC Imports Ltd', amount: '$5,000', frequency: 'Monthly', nextRun: 'Jan 20, 2024', status: 'active' },
  { id: 2, name: 'Weekly Services - Global Trade', client: 'Global Trade Co', amount: '$2,500', frequency: 'Weekly', nextRun: 'Jan 22, 2024', status: 'active' },
  { id: 3, name: 'Quarterly Consulting', client: 'Pacific Rim Ltd', amount: '$15,000', frequency: 'Quarterly', nextRun: 'Apr 1, 2024', status: 'paused' },
  { id: 4, name: 'Monthly Logistics', client: 'Euro Logistics', amount: '$3,200', frequency: 'Monthly', nextRun: 'Feb 1, 2024', status: 'active' },
];
    ...
    <div className="min-h-screen bg-[#f7f5f1]">
        ...
        <div className="container mx-auto max-w-6xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center text-white">
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto">
              Automate invoice generation and never miss a billing cycle.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-sm text-[#4A4A4A]">Active Rules</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-sm text-[#4A4A4A]">Invoices/Month</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <p className="text-2xl font-bold text-[#154230]">98%</p>
              <p className="text-sm text-[#4A4A4A]">On-Time Rate</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <Link href="/billing/invoices/new" className="bg-[#154230] rounded-xl p-6 shadow-sm hover:opacity-90 transition-opacity flex items-center gap-4">
              ...
              <div className="text-left">
                <h3 className="font-bold text-white">New Auto-Invoice Rule</h3>
                <p className="text-sm text-white/70">Create automated billing rules</p>
              </div>
            </Link>
            <Link href="/billing/invoices/recurring" className="bg-[#5D1E21] rounded-xl p-6 shadow-sm hover:opacity-90 transition-opacity flex items-center gap-4">
              <div className="w-14 h-14 bg-white/20 rounded-xl flex items-center justify-center">
                <Settings className="w-7 h-7 text-white" />
              </div>
              <div className="text-left">
                <h3 className="font-bold text-white">Manage Rules</h3>
                <p className="text-sm text-white/70">Edit existing auto-invoice rules</p>
              </div>
            </Link>
          </div>

          {/* Auto-Invoice Rules List */}
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
            <div className="p-6 border-b border-black/5">
              <h2 className="text-xl font-bold text-[#101111]">Auto-Invoice Rules</h2>
            </div>
            <div className="p-6">
              <div className="space-y-4">
                {autoInvoiceRules.map((rule) => (
                  <div key={rule.id} className="flex items-center justify-between p-4 bg-[#f7f5f1] rounded-xl">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-[#4A4A4A]">{rule.client} - {rule.frequency}</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        <div className="font-bold text-[#101111]">{rule.amount}</div>
                        <div className="text-sm text-[#4A4A4A]">Next: {rule.nextRun}</div>
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="bg-[#154230] rounded-xl p-6 text-center">
              ...
              <h3 className="font-bold text-white mb-2">Scheduled Billing</h3>
              <p className="text-sm text-white/70">Set up daily, weekly, monthly, or quarterly billing cycles</p>
            </div>
            <div className="bg-[#5D1E21] rounded-xl p-6 text-center">
              <CheckCircle className="w-10 h-10 text-white mx-auto mb-3" />
              <h3 className="font-bold text-white mb-2">Automatic Delivery</h3>
              <p className="text-sm text-white/70">Invoices are automatically sent to clients on schedule</p>
            </div>
            <div className="bg-[#154230] rounded-xl p-6 text-center">
              <FileText className="w-10 h-10 text-white mx-auto mb-3" />
              <h3 className="font-bold text-white mb-2">Custom Templates</h3>
              <p className="text-sm text-white/70">Use your branded invoice templates for auto-generated invoices</p>
            </div>
          </div>
        </div>
      </main>
      ...
      <section className="bg-gradient-to-br from-[#154230] to-[#1a5a3a] px-4 sm:px-8 py-16">
        <div className="container mx-auto max-w-4xl text-center text-white">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">Automate Your Billing Today</h2>
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
            Set up auto-invoicing and save hours every month on manual billing tasks.
          </p>
          <Link href="/signup" className="inline-flex items-center gap-2 px-8 py-3 bg-white text-[#154230] font-semibold rounded-lg hover:bg-white/90 transition-colors">
            Start Auto-Invoicing <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </section>
