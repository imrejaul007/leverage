        ...
        <div className="container mx-auto px-4 sm:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="hidden sm:inline text-sm text-[#4A4A4A] font-medium">AI</span>
            </Link>

            {/* Desktop Nav */}
            <nav className="hidden lg:flex items-center gap-8">
              <Link href="/" className="nav-link font-medium">Home</Link>
              <Link href="/ai" className="nav-link font-medium">Chat</Link>
              <Link href="/ai/agents" className="nav-link font-medium">AI Agents</Link>
              <Link href="/ai/consultations" className="nav-link font-medium">Consultations</Link>
            </nav>
          ...
          {mobileMenuOpen && (
            ...
            >
              <nav className="flex flex-col gap-2">
                ...
                <Link href="/ai/consultations" onClick={() => setMobileMenuOpen(false)} className="p-3 hover:bg-black/5 rounded-lg font-medium">Consultations</Link>
              </nav>
            </motion.div>
          )}
        </div>
